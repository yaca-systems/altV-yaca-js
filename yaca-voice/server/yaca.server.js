...
export class YaCAServerModule {
    ...
    radioTalkingState(player, state, distanceToTowerFromSender, secondaryChannel) {
        ...
        const radioFrequency = player.radioSettings.frequencies[secondaryChannel ? player.radioSettings.secondaryChannel : player.radioSettings.currentChannel];
